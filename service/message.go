...
func (messageService *MessageService) Query(beginID int64, beginTime int64, endTime int64, receiverID int64) ([]dbe.MessageWithUser, error) {
	var msgList []dbe.MessageWithUser
